...
Carregar Página "WOMEN"
    Wait Until Element Contains         ${PAGEHOMENAVIGATIONMENU.MenuLateralWOMEN}     ${PAGEHOMENAVIGATIONMENU.TextWOMEN}    3s
...
Carregar Página "DRESSES"
    Wait Until Element Contains         ${PAGEHOMENAVIGATIONMENU.MenuLateralDRESSES}    ${PAGEHOMENAVIGATIONMENU.TextDRESSES}    3s
...
Carregar Página "T-SHIRT"
    Wait Until Element Contains         ${PAGEHOMENAVIGATIONMENU.MenuLateralTSHIRT}    ${PAGEHOMENAVIGATIONMENU.TextTSHIRT}    3s
...
Acionar Link "WOMEN > TOP"
    ...
    Wait Until Element Is Visible       ${PAGEHOMENAVIGATIONMENU.MenuWOMEN}          3s
    Click Link                          ${PAGEHOMENAVIGATIONMENU.LinkWOMENTOP}

Carregar página "WOMEN > TOP"
    Wait Until Element Contains         ${PAGEHOMENAVIGATIONMENU.MenuLateralTOPS}     ${PAGEHOMENAVIGATIONMENU.TextTOPS}    3s
...
Carregar página "WOMEN > Blouses"
    Wait Until Element Contains         ${PAGEHOMENAVIGATIONMENU.MenuLateralBlouses}     ${PAGEHOMENAVIGATIONMENU.TextBlouses}    3s
...
Acionar Link "DRESSES > CASUAL DRESSES"
    ...
    Wait Until Element Is Visible       ${PAGEHOMENAVIGATIONMENU.MenuDRESSES}          3s
    Click Link                          ${PAGEHOMENAVIGATIONMENU.LinkCasualDresses}

Carregar página "DRESSES > CASUAL DRESSES"
    Wait Until Element Contains         ${PAGEHOMENAVIGATIONMENU.MenuLateralCasualDresses}     ${PAGEHOMENAVIGATIONMENU.TextCasualDresses}    3s
...
Carregar página "DRESSES > EVENING DRESSES"
    Wait Until Element Contains         ${PAGEHOMENAVIGATIONMENU.MenuLateralEveningDresses}     ${PAGEHOMENAVIGATIONMENU.TextEveningDresses}    3s
...
Carregar página "DRESSES > SUMMER DRESSES"
    Wait Until Element Contains         ${PAGEHOMENAVIGATIONMENU.MenuLateralSummerDresses}     ${PAGEHOMENAVIGATIONMENU.TextEveningDresses}    3s
...
Exibir mensagem de endereço de email inválido ao usuário (Endereço de Email Vazio)
    Wait Until Element Contains         ${PAGEHOMENAVIGATIONNEWSLETTER.Boxmsginvalidemailaddress}    ${PAGEHOMENAVIGATIONNEWSLETTER.Msginvalidemailaddress}    3s
    Capture Page Screenshot
    TempoExecução
...
Exibir mensagem de endereço de email já cadastrado (Endereço de Email já Cadastrado)
    Wait Until Element Contains         ${PAGEHOMENAVIGATIONNEWSLETTER.Boxmsginvalidemailaddress}    ${PAGEHOMENAVIGATIONNEWSLETTER.Msgregisteredemailregisteredaddress}    3s
    Capture Page Screenshot
    TempoExecução
...
Exibir mensagem de endereço de email cadastrado com sucesso
    Wait Until Element Contains         ${PAGEHOMENAVIGATIONNEWSLETTER.Boxmsginvalidemailaddress}    ${PAGEHOMENAVIGATIONNEWSLETTER.Msgsuccessfullynewsletter}    3s
    Capture Page Screenshot
    TempoExecução
...
Exibir página "New products" acionada pelo link "New products"
    Get Title
    ScrollPagesLinkFooter
    Wait Until Element Contains         ${PAGEHOMENAVIGATIONFOOTER.BoxNewproducts}           ${PAGEHOMENAVIGATIONFOOTER.MessengerBoxNewproducts}
    Capture Page Screenshot
    TempoExecução
    Go Back
